...
const Searchpage=()=>
{
    ...
    return(<div className="search-product-box">
        ...
        return(<div className="row" style={{border:"1px solid rgb(240, 240, 240)"}}>
            <div className="col-3 d-flex align-items-center justify-content-center" style={{height:"8rem",borderRight:"1px solid rgb(240, 240, 240)"}}><img src={item.src}></img></div>
            <div className="col-9">
                <div className="row"><div className="product-name" style={{marginTop:"1rem",height:"fit-content"}}>{item.MedicineName}</div></div>
                <div className="row"><div className="product-manufacturer" style={{marginTop:".3rem",height:"fit-content"}}>{item.Manufacturers}</div></div>
                <div className="row"><div className="product-bestprice" style={{marginTop:".3rem",height:"fit-content"}}>Rs.{bestPrice}</div></div>
