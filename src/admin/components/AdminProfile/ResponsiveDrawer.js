      ...
      <AppBar position="fixed" open={open}>
        <Toolbar className='drawer'>
          ...
          <Typography variant="h6" noWrap className='logo-wrapper' >
            ...
            <div className="admin-info"> <div className='admin-pic'><img src={user?user.image:""} alt="admin-profile" 
            height="50px" width="60px"></img></div>
            <div className='admin-name'>{user?user.name:""}</div></div>
          </Typography>
        </Toolbar>
      </AppBar>
        ...
        <List className='list-item'>
          <div className='list-box'>
            ...
            <ListItem button>
              ...
              <Link className="link-decoration" to="/admin/dashboard/settings"><ListItemText primary="Account Settings" /></Link>
            </ListItem>
            <ListItem button>
              <ListItemIcon>
              <LogoutIcon onClick={logOut} className="dashboard-icons"/>
              </ListItemIcon>
